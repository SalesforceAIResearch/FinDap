...
accelerate launch --config_file '${ROOT_DIR}/SFR-Continual-Pretrain/yaml/fsdp_config_16.yaml' \
    ...
    --downsample \
    --additional_note _fineweb_downsample_from_v1 \
    --idrandom 'dapt_mix_sft_mix_full_extend_exercise_book' \
    --baseline 'comb' \
    --model_name 'zixuan/qwen_32b_v1' \
    ...
    --resume_from_checkpoint ${ROOT_DIR}/result/dapt_mix_sft_mix_full_extend_exercise_book/sft_5e-06_8000_cfa_extracted_exercise_sup_zixuan/qwen_32b_v1_fineweb_downsample_from_v1/checkpoint-6000
